...
import sully.raptoreum.javaraptoreumdrpcclient.GenericRpcException;
...
import sully.raptoreum.javaraptoreumdrpcclient.RaptoreumdRpcClient.ScanObject;
import sully.raptoreum.javaraptoreumdrpcclient.RaptoreumdRpcClient.UnspentTxOutput;
import sully.raptoreum.javaraptoreumdrpcclient.RaptoreumdRpcClient.UtxoSet;
...
public class BitcoinJSONRPCClientTest {
    ...
    class MyClientTest extends RaptoreumJSONRPCClient {
    ...
    public void signRawTransactionTest() throws Exception {
        client = new MyClientTest(false, "signrawtransaction", null,
                                    "{\n" +
                                            ...
                                            "  \"complete\": true\n" +
                                            "}\n");
        LinkedList<RaptoreumdRpcClient.ExtendedTxInput> inputList = new LinkedList<RaptoreumdRpcClient.ExtendedTxInput>();
