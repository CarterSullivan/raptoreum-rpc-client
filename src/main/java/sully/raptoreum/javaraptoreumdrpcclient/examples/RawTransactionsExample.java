package sully.raptoreum.javaraptoreumdrpcclient.examples;
...
import sully.raptoreum.javaraptoreumdrpcclient.RaptoreumRawTxBuilder;
import sully.raptoreum.javaraptoreumdrpcclient.RaptoreumdRpcClient;
import sully.raptoreum.javaraptoreumdrpcclient.RaptoreumdRpcClient.ExtendedTxInput;
import sully.raptoreum.javaraptoreumdrpcclient.RaptoreumdRpcClient.MultiSig;
import sully.raptoreum.javaraptoreumdrpcclient.RaptoreumdRpcClient.RawTransactionSigningOrVerificationError;
import sully.raptoreum.javaraptoreumdrpcclient.RaptoreumdRpcClient.SignedRawTransaction;
import sully.raptoreum.javaraptoreumdrpcclient.RaptoreumdRpcClient.TxInput;
import sully.raptoreum.javaraptoreumdrpcclient.RaptoreumdRpcClient.Unspent;
...
public class RawTransactionsExample
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		RaptoreumdRpcClient client = new RaptoreumJSONRPCClient();
	...
	static void signRawTransactionWithKeyTest_P2SH_MultiSig(RaptoreumdRpcClient client)
	{
		...
		RaptoreumRawTxBuilder rawTxBuilder = new RaptoreumRawTxBuilder(client);
	 ...
	 */
	static void signRawTransactionWithKeyTest_P2SH_P2WPKH(RaptoreumdRpcClient client)
	{
